...
import 'package:coding_challenge_2/src/servus_flutter/l10n/localization_extension.dart';
import 'package:coding_challenge_2/src/servus_flutter/notifier/challenge_tester_notifier.dart';
...
class ChallengeTester extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final state = ref.watch(challengeTesterNotifierProvider.call(testId));
    return Column(
        ...
        ElevatedButton(
          onPressed: state.isLoading
              ...
              : () async {
                  ...
                  ref
                      .read(
                          challengeTesterNotifierProvider.call(testId).notifier)
